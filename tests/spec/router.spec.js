  ...
  function(fw, _) {
    describe('router', function() {
      ...
      it('can trigger a specified name-based route', function(done) {
        ...
        setTimeout(function() {
          expect(initializeSpy).toHaveBeenCalled();
          router.pushState(mockNamedState, { name: true });
          expect(routeControllerSpy).toHaveBeenCalled();
      ...
      it('can trigger a specified name-based route with a command', function(done) {
        ...
        setTimeout(function() {
          expect(initializeSpy).toHaveBeenCalled();
          routerNS.publish('pushState', { name: mockNamedState });
          expect(routeControllerSpy).toHaveBeenCalled();
            ...
            routes: [
              {
                route: mockUrl,
                controller: function() {
                  this.outlet('output', outletCallbackName, triggerOutletCallbackControllerSpy = jasmine.createSpy('triggerOutletCallbackControllerSpy', function(element) {
